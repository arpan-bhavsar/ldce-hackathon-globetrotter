    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto p-6 mt-8">
        <div className="text-center mb-10">
          ...
          <div className="max-w-2xl mx-auto flex shadow-md rounded-full overflow-hidden">
            <input 
              type="text" 
              placeholder="Search for a city, country, or activity..." 
        ...
        <h3 className="text-2xl font-bold text-slate-800 mb-6">Trending Destinations</h3>
